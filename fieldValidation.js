...
function geoJsonFileReader(path) {
    try {
...
let geoJsonObject = geoJsonFileReader(pathFile)
if (geoJsonObjectValidator(geoJsonObject)) console.log("valid!");
else console.log("no valid file!");
